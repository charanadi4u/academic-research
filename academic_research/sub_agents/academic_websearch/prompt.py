...
Objective: Identify and list academic papers that cite the provided seminal paper AND
...
"papers citing [seminal paper]" publication year current year
site:scholar.google.com "[seminal paper]" YR=current year
"cited by" "[seminal paper]" published previous year
"papers citing [seminal paper]" publication year previous year
site:scholar.google.com "[seminal paper]" YR=previous year
